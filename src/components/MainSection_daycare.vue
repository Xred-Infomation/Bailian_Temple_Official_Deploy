...
onMounted(async () => {
  try {
    const res = await api.get('/officialMana/getCarouselImg/dayCare')
    console.log(res)
  ...
  <main>
    <div class="about-container">
      <section class="header-section">
        <h1 class="main-title">一起動起來，樂齡不無聊</h1>
        <p class="subtitle">一起歡笑、一起學習──樂齡共學時光，溫暖陪伴每一天</p>
      </section>

      <section class="content-section">
        <!-- <img class="about-image" src="@/assets/images/mainPic2.jpg" alt="日托中心" /> -->
        ...
        <div class="about-text">
          <p>{{ aboutText.daycare1 }}</p>
          <p>{{ aboutText.daycare2 }}</p>
        </div>
